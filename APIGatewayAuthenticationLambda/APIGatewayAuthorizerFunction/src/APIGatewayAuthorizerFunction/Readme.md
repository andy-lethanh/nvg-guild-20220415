...
WORKDIR /src
COPY ["APIGatewayAuthorizerFunction.csproj", "APIGatewayAuthorizerFunction/"]
RUN dotnet restore "APIGatewayAuthorizerFunction/APIGatewayAuthorizerFunction.csproj"

WORKDIR "/src/APIGatewayAuthorizerFunction"
COPY . .
RUN dotnet build "APIGatewayAuthorizerFunction.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "APIGatewayAuthorizerFunction.csproj" \
...
Execute unit tests
```
cd "APIGatewayAuthorizerFunction/test/APIGatewayAuthorizerFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "APIGatewayAuthorizerFunction/src/APIGatewayAuthorizerFunction"
